...
public struct NetCodeTestGhostDeserializerCollection : IGhostDeserializerCollection
{
        ...
        ref DataStreamReader reader, NetworkCompressionModel compressionModel)
    {
        ...
        {
            case 0:
                return GhostReceiveSystem<NetCodeTestGhostDeserializerCollection>.InvokeDeserialize(m_CubeSnapshotDataFromEntity, entity, snapshot, baseline, baseline2,
        ...
        NetworkCompressionModel compressionModel)
    {
        switch (serializer)
        {
            case 0:
                ...
                m_CubeSnapshotDataNewGhosts.Add(GhostReceiveSystem<NetCodeTestGhostDeserializerCollection>.InvokeSpawn<CubeSnapshotData>(snapshot, ref reader, compressionModel));
                break;
            default:
                throw new ArgumentException("Invalid serializer type");
        }
...
public struct EnableNetCodeTestGhostReceiveSystemComponent : IComponentData
{}
public class NetCodeTestGhostReceiveSystem : GhostReceiveSystem<NetCodeTestGhostDeserializerCollection>
{
